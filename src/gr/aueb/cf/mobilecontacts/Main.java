...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Thank yuo for using Mobile Contacts App");
    }
    ...
    public static void handleChoice(String choice){
        ...
        switch (choice) {
            case "1":
                System.out.println("Παρακαλω εισάγετε ¨ονομα, επώνυμο, Αρ. τηλεφώνου");
                firstname = getToken();
                lastname = getToken();
    ...
    public static void printMenu() {
        ...
        System.out.println("1. Εισαγωλη επαφής");
